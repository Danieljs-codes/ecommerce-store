...
const DropdownKeyboard = ({
  ...
  return (
    <Keyboard
      classNames={{
        base: twMerge(
          'absolute right-2 pl-2 group-hover:text-primary-fg group-focus:text-primary-fg gap-0.5 font-sans text-[10.5px] uppercase *:inset-ring *:inset-ring-muted-fg/20 *:grid *:size-5.5 *:place-content-center *:rounded-xs *:bg-bg',
          className,
        ),
      }}
      {...props}
